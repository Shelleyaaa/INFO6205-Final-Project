...
public class LSDChineseSortTest {
    ...
    static String[] getWords(final String resource, final Function<String, List<String>> stringListFunction) {
        try {
            final File file = new File(getPathname(resource, LSDChineseSortTest.class));
