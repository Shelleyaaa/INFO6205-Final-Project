...
import static edu.neu.coe.info6205.sort.huskySortUtils.HuskySortHelper.generateRandomAlphaBetaArray;
...
public class HuskySortTest {
    ...
    public void testSortOldDate() {
        ...
        AbstractHuskySort<Date> sorter = new edu.neu.coe.info6205.sort.huskySort.QuickHuskySort<>(HuskyCoderFactory.dateCoder, config);
        assertTrue("sorted", sorter.getHelper().sorted(sorter.sort(xs)));
    }
    ...
    public void testSortJavaTime() {
        ...
        QuickHuskySort<ChronoLocalDateTime<?>> sorter = new edu.neu.coe.info6205.sort.huskySort.QuickHuskySort<>(HuskyCoderFactory.chronoLocalDateTimeCoder, config);
        assertTrue("sorted", sorter.getHelper().sorted(sorter.sort(xs)));
    }
